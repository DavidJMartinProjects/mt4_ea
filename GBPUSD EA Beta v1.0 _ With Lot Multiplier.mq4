     ...
     if(tradingAllowed() == true) {
         ...
         if(TotalOpenOrders() == 0) {
             ...
             if(buy != EMPTY_VALUE && buy < 2147483647 && fast_uptrend < 2147483647 && slow_uptrend < 2147483647){
                 orderTicket = OrderSend(_Symbol,OP_BUY,getLotSize(),Ask,Slippage,Ask-StopLoss*_Point,Ask+TakeProfit*_Point,"BUY",MagicNumber);
                 ...
                 orderTicket = OrderSend(_Symbol,OP_SELL,getLotSize(),Bid,Slippage,Bid+StopLoss*_Point,Bid-TakeProfit*_Point,"SELL",MagicNumber);//Opening Sell
...
//      "\n" + 
      ...
      AddDashBoardMessage("");      
      AddDashBoardMessage("Symbol: GBPUSD");
      AddDashBoardMessage("Strategy: 5 pip, 40/40");      
      AddDashBoardMessage("");
...
void Display(string text)
{
  ...
  ObjectSet("EA-BG", OBJPROP_YSIZE,317);
